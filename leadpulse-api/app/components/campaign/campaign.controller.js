...
class CampaignController
{
  ...
  strandedLeads = asyncHandler(async (req, res) =>
  {
    const leads = await campaignService.getStrandedLeads(req.params.id, req.user.id);
  ...
  {
    const campaign = await campaignService.deleteDraftCampaign(req.params.id, req.user.id);
